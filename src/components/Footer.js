...
export default function Footer() {
  ...
  return (
    <footer>
      <a className={animation1} onMouseEnter={() => setAnimation1('animate__animated animate__bounce animate__repeat-3')} onMouseLeave={() => setAnimation1('')}
      target="_blank" href="https://github.com/tbgolfer86" rel="noreferrer"><img src={gitHub} alt="GitHub logo" /></a>
      <a className={animation2} onMouseEnter={() => setAnimation2('animate__animated animate__bounce animate__repeat-3')} onMouseLeave={() => setAnimation2('')}
      target="_blank" href="https://www.linkedin.com/in/anthony-battinelli" rel="noreferrer"><img src={linkedIn} alt="LinkedIn logo" /></a>
      <a className={animation3} onMouseEnter={() => setAnimation3('animate__animated animate__bounce animate__repeat-3')} onMouseLeave={() => setAnimation3('')}
